<template>
  <div class='sub-sort'>
    <div class="sort">
      ...
      <a :class="{active:sortParams.sortField == 'pulishTime'}" @click="changeSort('pulishTime')" href="javascript:;">最新商品</a>
    ...
    <div class="check">
      <EcsCheckbox @change="changeChecked" v-model="sortParams.inventory">仅显示有货商品</EcsCheckbox>
      <EcsCheckbox @change="changeChecked" v-model="sortParams.onlyDiscount">仅显示特惠商品</EcsCheckbox>
    </div>
  </div>
</template>
<script>
